...
def main():
 ...
 activites = ["ExploringDataAnalysis","Pandas-Profiling","Data Visualization","LazyRegressor(Beta)","LazyClassifier(Beta)"]
	...
	if st.button("Generate Report):
     ...
     if st.checkbox("Quick Analysis"):
         ...
         if select_=="Pair Plot":
               ...
               st.pyplot()
 elif choice== "LazyRegressor(Beta)" and data is not None:
 ...
 elif choice=="LazyClassifier(Beta)" and data is not None:
     df=df.loc[:100]
